...
namespace iPipelinePStepWebService.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CVG_NUM = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CLI_ADDR_YR_DUR_DUR = table.Column<decimal>(type: "decimal(13,0)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CLI_ADDR_ADDL_TXT = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CLI_CNCT_EMAIL = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CVG_PLAN_ID = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
